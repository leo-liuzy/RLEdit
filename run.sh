...
python main.py dataset=cre model=llama3.2-1B-eos-sft-template-format-curated-v1-lr2e-6-sample-10-4-15 editor=rledit num_seq=2 editor.n_epochs=800 dataset.n_edits=5 eval_every_epoch=32
