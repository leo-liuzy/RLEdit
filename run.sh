...
CUDA_VISIBLE_DEVICES=0 python main.py dataset=cre model=llama3.2-1B-eos-sft-template-format-curated-v1-lr2e-6-sample-10-4-15 editor=rledit num_seq=10 editor.n_epochs=1000 dataset.n_edits=2 dataset.batch_size=1